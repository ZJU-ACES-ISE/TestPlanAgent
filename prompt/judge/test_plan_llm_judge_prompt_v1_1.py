...
YOUR RESPONSE MUST BE ONLY THE FOLLOWING JSON FORMAT WITH NO ADDITIONAL TEXT:
...
DO NOT include any introduction, explanation, or conclusion outside this JSON structure. Replace the placeholder values with your actual scores (1-10) and analysis. The total_score should be the sum of the three individual scores (maximum 30).
...
2. For each criterion, think through your analysis but put your final evaluation ONLY in the JSON output.
3. Be specific in your analysis, citing particular examples from both the reference and candidate.
4. Consider the context of GitHub PRs, where implementation steps need to be practical and actionable.
5. After completing your analysis, format your response STRICTLY as the JSON structure provided above.
...
- DO NOT forget to calculate the total_score as the sum of the three individual scores
