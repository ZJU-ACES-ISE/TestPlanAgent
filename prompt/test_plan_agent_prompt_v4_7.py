...
- Get second page of results: {"pattern": "*.py", "cursor": 1}
- Change page size: {"pattern": "*.py", "page_size": 50}
...
When you believe that you have gathered sufficient information to complete the testing program or receive notification from me, please provide your conclusions in the following format:
