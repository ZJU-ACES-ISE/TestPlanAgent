...
1. Use view_code_changes to understand what code has changed in the PR. Focus on identifying:
   - What files were modified?
   - What functionality was added, modified, or removed?
   - Are there any complex logic changes?

2. For each changed file/component:
...
5. Only write your test plan when you have:
