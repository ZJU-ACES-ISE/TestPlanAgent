...
def generate_config(pr_url, llm_model, output_dir, strategy, judge_llm_model, api_key=None, llm_url=None):
    """
    ...
    output_file_name = f"{llm_model}_{pr_number}.txt"
    ...
    config = {
        'CKG': {
            'project_dir': f"./test_projects/{repo}",
...
def main():
    ...
    # PR和模型设置
    parser.add_argument('--pr_url', default='https://api.github.com/repos/Opentrons/opentrons/pulls/16571', 
                       help='GitHub PR URL or file containing PR URLs')
    parser.add_argument('--model', type=str, 
                       choices=['claude-3-5-sonnet-20241022', 'deepseek-v3', 'qwen-max-latest',
    ...
    parser.add_argument('--test-plan-path', type=str,
    ...
    # 多线程参数
    parser.add_argument('--multi-threading', action='store_true',
